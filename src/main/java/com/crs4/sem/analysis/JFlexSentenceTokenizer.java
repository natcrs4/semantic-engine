...
public class JFlexSentenceTokenizer extends Tokenizer {
	...
	public JFlexSentenceTokenizer(AttributeFactory factory) {
		super(factory);
		init();
	}

	public JFlexSentenceTokenizer() {
		this.returnPunctuation=false;
		init();
	}

	public JFlexSentenceTokenizer(boolean returnPunctuaction) {
	...
	public final boolean incrementToken() throws IOException {
		...
		while (true) {
			...
			if (scanner.yylength() <= maxTokenLength) {
				...
				typeAtt.setType(JFlexSentenceTokenizer.TOKEN_TYPES[tokenType]);
				// return true;
			} else
